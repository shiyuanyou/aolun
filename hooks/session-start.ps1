...
function ConvertTo-AsciiJsonString {
    ...
    for ($i = 0; $i -lt $Value.Length; $i++) {
        ...
        if ($codePoint -lt 32 -or $codePoint -gt 126) {
            [void]$builder.AppendFormat('\u{0:x4}', $codePoint); continue
        }
