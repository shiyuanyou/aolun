...
description: "拆解技术帖子/论断/方案的第一步：解剖概念层——声称是什么、定义是否自洽、术语是否被偷换。"
---
...
**本 skill 特有的 fileflow 责任：** 概念层解剖完成后，须在 `00-todolist.md` 的"语义线索"部分追加关键位置索引（核心声称所在行号、疑似概念偷换位置、关键论证链起点等）——粘贴/单文件模式用 `第<N>行` 格式，目录模式用 `<文件名>:<N>` 格式。
